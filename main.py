...
colores = ['#92bcea'] * (len(ultimos_10_anos)-2) + ['blue', 'blue']
...
st.title("KPI-3")
st.title("Tasa de mortalidad promedio por Operador")
...
# Definir una lista de colores para las barras
colores = ['#92bcea', '#92bcea', '#92bcea', '#92bcea', '#92bcea', '#92bcea', '#92bcea', '#92bcea', '#92bcea', ]
...
st.title("KPI-4")
st.title("Tasa de mortalidad por ruta")
...
ax.barh(rango_barras, tasa_mortalidad, color='#92bcea')
ax.set_yticks(rango_barras)
